<form method="post" enctype="multipart/form-data" target="gform_ajax_frame_2" id="gform_2" action="">
    <div class="field-full-name">
        ...
        <div class=" field template-row template-no-gutters col-6-child-50">
    ...
    <div class="field-address-main field">
        ...
        <div class="city-state-container i-container template-row template-no-gutters col-6-child-50">
    ...
    <div class="field-consent field">
        ...
        <div>
            ...
            <label for="consent" class="pointer"> ...I have read and agree to terms & conditions</label><span class="br"></span>
        </div>
